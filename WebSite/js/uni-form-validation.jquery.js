...
jQuery.fn.uniform.language = {
    ...
    email         : '%s Email invalido',
    url           : '%s no es una URL valida',
    number        : '%s Ingrese un numero',
    ...
    callback      : 'Archivo no valido %s . comuniquese con el admin (%s) !',
    on_leave      : 'Esta seguro de abandonar?',
    submit_msg    : 'Error, Debe diligenciar la informacion .',
    submit_help   : 'Observe los campos resaltados.',
    submit_success: 'OK.'
};
